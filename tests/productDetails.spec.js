...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.strictEqual(typeof products, 'array');
    ...
    assert.strictEqual(products[0].details.productId, `${'Alcool gel'}123`);
    assert.strictEqual(products[1].details.productId, `${'Máscara'}123`);
  });
});
