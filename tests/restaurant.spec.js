...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    const menuObjeto = { food: {}, drink: {} };
    const objetoRetornado = createMenu(menuObjeto); // Retorno: { fetchMenu: () => {}, ... }
    assert.strictEqual(typeof (objetoRetornado.pay()), 'object');
    // ```
    ...
    assert.strictEqual(objetoRetornado.fetchMenu(), menuObjeto);
