...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    const objecto = { food: {}, drink: {} };
    assert.strictEqual(typeof createMenu(objecto), 'object');
    ...
    // ```
    let objetoRetornado = createMenu(objecto);
    ...
    assert.deepStrictEqual(objecto, objetoRetornado.fetchMenu());
    ...
    // ```
    objetoRetornado.consumption = [];
    objetoRetornado = createMenu({ food: { coxinha: 5.5 }, drink: { agua: 1.5 } });
    objetoRetornado.order('coxinha');
    objetoRetornado.order('agua');
    objetoRetornado.order('coxinha');
    assert.strictEqual(objetoRetornado.pay(), 12.5);
