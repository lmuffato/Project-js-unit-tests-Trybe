...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    let objectTest = { food: { coxinha: 3.90, sanduiche: 9.90 }, drinks: { agua: 3.90, cerveja: 6.90 } };
    assert.strictEqual(typeof (createMenu(objectTest).fetchMenu), 'function');
    ...
    // --------------------------------------------------------------------------------------
    const objetoRetornado = createMenu(objectTest);
    ...
    // ```
    const newObject = createMenu(objectTest);
    newObject.order('coxinha');
    newObject.order('coxinha');
    newObject.order('agua');
    // objetoRetornado.order('coxinha');
    // objetoRetornado.order('agua');
    // objetoRetornado.order('coxinha');
    // objetoRetornado.pay() // Retorno: somaDosPreçosDosPedidos
    // consultado metodo "tofixed()" em: https://developer.mozilla.org/pt-BR/docs/Web/JavaScript/Reference/Global_Objects/Number/toFixed
    assert.deepStrictEqual(newObject.pay(), 12.87);
