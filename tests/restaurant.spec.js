...
*/
// npm run test /tests/restaurant.spec.js

describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    const objectItem = { food: { coxinha: 5.5, sopa: 8.9, sashimi: 12.9 }, drink: { agua: 4.5 } };
    const returnedObject = createMenu(objectItem);
    assert.strictEqual(typeof returnedObject.fetchMenu, 'function');

    const emptyObject = createMenu({ food: {}, drink: {} });
    const expectedKeys = ['food', 'drink'];
    assert.deepStrictEqual(Object.keys(emptyObject.fetchMenu()), expectedKeys);
