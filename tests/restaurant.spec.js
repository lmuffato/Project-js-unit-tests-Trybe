...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const array = Object.keys(objetoRetornado.fetchMenu);
    assert.strictEqual(typeof createMenu().fetchMenu, 'undefined');
    assert.strictEqual(array[0], 'food');
    assert.strictEqual(array[1], 'drink');
    assert.strictEqual(objetoRetornado.fetchMenu, obj);
