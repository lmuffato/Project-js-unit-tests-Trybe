...
describe('#circle', () => {
  it('given a radius, should return an object with circles info', () => {
    ...
    raio3.area = parseFloat((raio3.area).toPrecision(5));
    raio3.circumference = parseFloat((raio3.circumference).toPrecision(5));
    assert.deepStrictEqual(raio3, { radius: 3, area: 28.26, circumference: 18.84 });
  });
});
