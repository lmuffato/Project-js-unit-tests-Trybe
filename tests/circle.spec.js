...
describe('#circle', () => {
  it('given a radius, should return an object with circles info', () => {
    ...
    const firstCircle = circle(3);
    firstCircle.area = parseFloat((circle(3).area).toPrecision(4));
    assert.deepStrictEqual(firstCircle, { radius: 3, area: 28.26, circumference: 18.84 });
